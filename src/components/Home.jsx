...
<section id='home'
  className="relative bg-[url(https://images.inc.com/uploaded_files/image/1920x1080/getty_649362670_395940.jpg)] bg-cover bg-center bg-no-repeat"
>
  <div
  ...
  >
    <div className="max-w-xl text-left sm:text-left justify-center">
